...
public class Hospede extends Pessoa {
	...
	public Hospede(String nome, String cpf, int telefone, int dia, int mes, int ano, 
			...
			int numero, int cep, String sexo, int codigoConta) {
		super(nome, cpf, telefone, dia, mes, ano, rua, bairro, cidade, 
				estado, complemento, numero, cep);
		setSexo(sexo);
		setCodigoConta(codigoConta);
	}
	
	public Hospede(String nome, String cpf, int telefone, Date dataNasc, 
			Endereco endereco, String sexo, int codigoConta, Hospedagem hospedagem) {
	...
	public Hospede(String sexo, int codigoConta) {
		setSexo(sexo);
		setCodigoConta(codigoConta);
	}
