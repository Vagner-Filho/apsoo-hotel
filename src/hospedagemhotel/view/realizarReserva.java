...
public class realizarReserva extends JFrame {
    ...
    public realizarReserva() throws ParseException {
        ...
        /*
         * JLabel lblValorTotal = new JLabel("Valor Total:"); lblValorTotal.setFont(new
         * Font("Tahoma", Font.PLAIN, 18)); lblValorTotal.setBounds(10, 404, 94, 22);
        ...
        btnCancelar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int resposta = JOptionPane.showConfirmDialog(null,
                        "Deseja mesmo cancelar a reserva e retornar ao menu inicial?", "Cancelar Reserva", 0);
                if (resposta == 0) {
        ...
        btnConfirmar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                System.out.println("botao confirmar clicado");
                sis.confirmarReserva(cpfCaixaDeTexto.getText(), dataInicialCaixaDeTexto.getText(),
                        dataFinalCaixaDeTexto.getText(), getQuarto());
